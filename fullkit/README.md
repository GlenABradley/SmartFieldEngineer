...
This implementation directory currently contains the reviewed contract, build configuration, real acceptance tests and empty reserved source directories. It does not contain a working application or success-returning stubs. Implement the contract and make the tests pass against real persistence/transport.
